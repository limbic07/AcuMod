...
`knowledge:build-dev` 构建固定数值数据库和三个文本包。`knowledge:verify-dev` 验证 `15.10.00` 内容基线、`15.23` 运行兼容标记、50 张源表、8,500 以上实体、3 万以上原始行，以及武器斩味、防具技能、怪物肉质/奖励、任务报酬、技能等级等固定 section；还会验证 MOD3、MRL3、EVAM、SOBJ 等技术文档、Acumod 使用说明和 18 条攻略摘要。
